...
def button_callback(channel):
    ...
    print(f"\nPedestrian button pressed on GPIO {channel}!")
...
def setup():
    ...
    # 500ms debounce
    GPIO.add_event_detect(MAIN_PED_BUTTON, GPIO.RISING, callback=button_callback, bouncetime=500)
    GPIO.add_event_detect(CROSS_PED_BUTTON, GPIO.RISING, callback=button_callback, bouncetime=500)
